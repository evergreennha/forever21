    ...
    <View style={{paddingTop: 40, flex: 1}}>
      <View style={{paddingHorizontal: 20}}>
        <View>
          ...
          />
          <Text style={{color:'red',fontSize: 17}}>Require field</Text>  
        </View> 
        ...
        <TouchableOpacity>
          <Text style={{marginTop:30,textAlign:'center',textDecorationLine:'underline'}}>Forgot password?</Text>
        </TouchableOpacity>

        <View style={{borderTopWidth:1,marginTop:30,borderColor:'grey'}}></View>

        <TouchableOpacity>
          <Text style={{marginTop: 30,textAlign:'center',textDecorationLine:'underline'}}>Don't have an account?</Text>
        </TouchableOpacity>

      </View>
      <View style={{backgroundColor:'#e3e2da',padding:20,position:'absolute',bottom:0,width:'100%'}}>
